...
<head>
    ...
    <script src="../../engine/js/electronica-registration.js"></script>                  
</head>
<body>    
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="pageOneInnerContainerForm"  data-aos="fade-right" data-aos-duration="500"  data-aos-delay="400">                                                        
                            <div class="catext"> Electronica Registration </div> 
                            <hr>                             
                            ...
                            <div class="form-row ">                                                                   
                                <div class="form-group col-md-6"> 
                                    ...
                                    <input name="memonecollegen" id="memonecollegen" type="text" class="form-control" placeholder="College/Institute Name" required>
                                </div> 
                                <div class="form-group col-md-6 "> 
                            ...
                            <div class="form-row ">                                                                   
                                <div class="form-group col-md-6"> 
                                    <label>College/Institute Name* </label> 
                                    <input name="memtwocollegen" id="memtwocollegen" type="text" class="form-control" placeholder="College/Institute Name" required>
                                </div> 
                                <div class="form-group col-md-6 "> 
                                    <label> Email ID* </label> 
