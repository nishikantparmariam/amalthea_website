...
<head>
    ...
    <script src="../../engine/js/inquizzed-registration.js"></script>                  
</head>
<body>    
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="pageOneInnerContainerForm"  data-aos="fade-right" data-aos-duration="500"  data-aos-delay="400">                                                        
                            <div class="catext"> Inquizzed Registration </div> 
                            <hr>                             
                            ...
                            <div class="form-row ">                                                                   
                                ...
                                <div class="form-group col-md-6"> 
                                    <label> Age*  </label> 
                                    <input name="memoneage" id="memoneage" type="number" class="form-control" placeholder="Age" required>
                                </div>                                                    
                            </div>
                            <div class="form-row ">                                                                   
                                <div class="form-group col-md-12"> 
                                    <label>Mobile Number* </label> 
                                    <input name="memonemobile" id="memonemobile" type="number" class="form-control" placeholder="Mobile Number" required>
                                </div>                                                         
                            </div>
                            <div class="form-row ">                                                                   
                                <div class="form-group col-md-6"> 
                            ...
                            <div class="form-row ">                                                                   
                                ...
                                <div class="form-group col-md-6"> 
                                    <label> Age*  </label> 
                                    <input name="memtwoage" id="memtwoage" type="number" class="form-control" placeholder="Age" required>
                                </div>                                                    
                            </div>
                            <div class="form-row ">                                                                   
                                <div class="form-group col-md-12"> 
                                    <label>Mobile Number* </label> 
                                    <input name="memtwomobile" id="memtwomobile" type="number" class="form-control" placeholder="Mobile Number" required>
                                </div>                                                         
                            </div>
                            <div class="form-row ">                                                                   
                                <div class="form-group col-md-6"> 
                                    <label>College Name* </label> 
                                    <input name="memtwocollegen" id="memtwocollegen" type="text" class="form-control" placeholder="College Name" required>
                                </div> 
                                <div class="form-group col-md-6 "> 
                                    <label> Email ID* </label> 
