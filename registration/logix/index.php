...
<head>
    ...
    <script src="../../engine/js/logix-registration.js"></script>                  
</head>
<body>    
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="pageOneInnerContainerForm"  data-aos="fade-right" data-aos-duration="500"  data-aos-delay="400">                                                        
                            <div class="catext"> Logix Registration </div> 
                            <hr>                             
                            ...
                            <div class="form-row "> 
                                <div class="form-group col-md-12"> 
                                    ...
                                    <input name="college" id="college" type="text" class="form-control" placeholder="College/Institution Name" required>
                                </div>                                   
                            </div>
