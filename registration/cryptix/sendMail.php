<?php
    ...
    if(isset($_GET['country'])&&isset($_GET['fullname'])&&isset($_GET['username'])&&isset($_GET['email'])&&!empty($_GET['email'])&&!empty($_GET['fullname'])&&!empty($_GET['username'])&&!empty($_GET['country'])){
        ...
        $message = "Hello ".$fullname.",<br><br> Greetings from Amalthea '19<br><br>Thanks for registering for CryptixCTF 2019. Your details are as follows: <br><br> Username : <b>".$username."</b><br>Fullname : <b>".$fullname."</b><br>Country : <b>".$country."</b><br><br>The link for the rulebook is <a href='http://amalthea.iitgn.ac.in/rulebooks/ctf.pdf'>here</a>.<br><br>Regards<br>Events Team Amalthea";
