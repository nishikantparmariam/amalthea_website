...
<head>
    ...
    <script src="../../engine/js/icon-registration.js"></script>                  
</head>
<body>    
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="pageOneInnerContainerForm"  data-aos="fade-right" data-aos-duration="500"  data-aos-delay="400">                                                        
                            <div class="catext"> ICON Registration </div> 
                            <hr>                             
                            <div class="registrationText" style="color:#ff0000;"> * marked are mandatory </div>
                            <br><b>Contestants will have to send complete details of their idea on the email id  amalthea.icon@gmail.com along with their choice of presentation (PPT/poster). </b>
                            <br>
                            <br>                            
                            <b>
                            ...
                            <div class="form-row "> 
                                ...
                                <div class="form-group col-md-6 "> 
                                    ...
                                    <input name="ccname" id="ccname" type="text" class="form-control" placeholder="Company/College Name" required>                                    
                                </div>    
                            </div>
                            <div class="form-row "> 
                                <div class="form-group col-md-12"> 
                                    <label> Idea Title* </label> 
                                    <input name="ideaname" id="ideaname" type="text" class="form-control" placeholder="Idea Name" required>
                                </div>                                   
                            </div>
                            <div class="form-row "> 
                                <div class="form-group col-md-12"> 
                                    <label> Brief Description* </label> 
                                    <textarea name="ideades" id="ideades" type="text" class="form-control" placeholder="Brief Description of the Idea" style="max-height:100px;min-height:100px;" required></textarea>
                                </div>                                   
                            </div>
                            <hr>
                            <b>First Member*   </b>
                            ...
                            <div class="form-row ">                                                                   
                                <div class="form-group col-md-6"> 
                                    ...
                                    <input name="memonemobile2" id="memonemobile2" type="text" class="form-control" placeholder="Alternate Mobile Numer" required>
                                </div> 
                                <div class="form-group col-md-6 "> 
