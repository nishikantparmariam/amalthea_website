...
<head>
    ...
    <script src="../../engine/js/dcode-registration.js"></script>                  
</head>
<body>    
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="pageOneInnerContainerForm"  data-aos="fade-right" data-aos-duration="500"  data-aos-delay="400">                                                        
                            <div class="catext"> D'code Registration </div> 
                            <hr>                             
                            ...
                            <div class="form-row "> 
                                <div class="form-group col-md-12"> 
                                    ...
                                    <input name="codechef_username" id="codechef_username" type="text" class="form-control" placeholder="Codechef Username" required>
                                </div>                                   
                            </div>
                            ...
                            <div class="form-row "> 
                                <div class="form-group col-md-12"> 
                                    ...
                                    <input name="email" id="email" type="text" class="form-control" placeholder="Email ID" required>
                                </div>                                   
                            </div>
                            ...
                            <div class="form-row "> 
                                <div class="form-group col-md-12"> 
                                    ...
                                    <input name="phone" id="phone" type="text" class="form-control" placeholder="Phone Number (With country code)" required>
                                </div>                                   
                            </div>
